...
class NaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nature" do
    assert_difference('Nature.count') do
      post natures_url, params: { nature: { category: @nature.category, description: @nature.description, image: @nature.image, name: @nature.name, price: @nature.price } }
    end
  ...
  test "should update nature" do
    patch nature_url(@nature), params: { nature: { category: @nature.category, description: @nature.description, image: @nature.image, name: @nature.name, price: @nature.price } }
